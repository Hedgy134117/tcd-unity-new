...
public class CameraMultipleTarget: MonoBehaviour
{
    ...
    /// <summary>
    /// Calculates a mainCamera position given the a bounding box containing all the targets.
    /// </summary>
    ...
    /// <summary>
    /// Calculates a new orthographic size for the mainCamera based on the target bounding box.
    /// </summary>
    /// <param name="boundingBox">A Rect bounding box containg all targets.</param>
    ...
    float CalculateOrthographicSize(Rect boundingBox)
    {
        ...
        return Mathf.Clamp(Mathf.Lerp(mainCamera.orthographicSize, orthographicSize, Time.deltaTime * zoomSpeed), minimumOrthographicSize, Mathf.Infinity);
    }
}